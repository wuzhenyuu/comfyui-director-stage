/*!
 * mp4-muxer v5.2.1 — https://github.com/Vanilagy/mp4-muxer (MIT License, (c) Vanilagy)
 * Vendored single-file ESM build (npm package mp4-muxer@5.2.1, build/mp4-muxer.mjs)
 * for comfyui-director-stage V2-F2 (MP4 reference video export). Do not edit.
 */
