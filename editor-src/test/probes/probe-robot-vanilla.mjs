...
new GLTFLoader().load("/director_stage/models/robot-expressive.glb", (g) => {
  scene.add(g.scene);
...
const server = http.createServer((req, res) => {
  ...
  if (p.startsWith("/director_stage/models/")) file = path.join(repoRoot, "ref-models", path.basename(p));
