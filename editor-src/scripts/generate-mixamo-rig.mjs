...
// 避免 node 环境下 window/document 缺失（three.js 需要）
global.window = global;
global.document = { createElement: () => ({ style: {}, getContext: () => null }) };

// Node.js polyfill for GLTFExporter
...
const headMesh = new THREE.SkinnedMesh(headGeo, new THREE.MeshStandardMaterial({ color: 0xddbb88, roughness: 0.4 }));
...
const outPath = "../assets/models/mixamo-rigged-character.glb";
